    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-6 text-center">
          <img src="gambar1.png" class="img-fluid" alt="">
        </div>
        <div class="col-xl-6 text-center">
          <h1>Nikmati seafood segar hanya dengan menunggu di rumah!</h1>
        </div>
      </div>
      <div class="text-center">
        <a href="{{route('marketplace.index')}}" class="btn-get-started scrollto">Yuk Belanja</a>
      </div>
