...
@section('content')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-4 order-1">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-6 mb-4">
                                <div class="card">
                                    ...
                                    <div class="card-title d-flex align-items-start justify-content-between">
                                        <div class="avatar flex-shrink-0" style="height: 3rem; width: 3rem">
                                        <img
                                    ...
                                    <h5 class="fw-semibold d-block mb-4 mt-4">Customer</h5>
                                    <h3 class="card-title mb-2 text-end">{{$pelanggan}}</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-6 mb-4">
                            <div class="card">
                                    ...
                                    <h5 class="fw-semibold d-block mb-4 mt-4">Nelayan</h5>
                                    <h3 class="card-title mb-2 text-end">{{$nelayan}}</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Transactions -->
                    <div class="col-md-4 col-lg-6 order-2 mb-4">
                    <div class="card h-100">
