                                    ...
                                    <div class="table-responsive text-nowrap">
                                        ...
                                        <div class="d-flex justify-content-end mt-4 ">
                                            @if ($or->status == 'On Prosess')
                                                <a class="btn btn-lg btn-block" href="{{ route('datatransaksi.index') }}" style="background-color: #128FE2; color: white;">Cek Pembayaran</a>
                                            @elseif($or->status == 'Barang Dikemas')
                                                <a class="btn" href="{{route('dataorder.cetakpesanan', $or->no_order)}}" style="background-color: #128FE2; color: white;">Cetak Pesanan</a>
                                                <a class="btn" href="{{route('dataorder.barangkirim', $or->id)}}" style="background-color: #128FE2; color: white;">Barang Dikirim</a>
                                            @endif
                                        </div>
                        </div>
                        @endforeach
                                    ...
                                    <div class="table-responsive text-nowrap">
                                        ...
                                        <div class="d-flex justify-content-end mt-4 ">
                                            @if ($or->status == 'On Prosess')
                                                <a class="btn btn-lg btn-block" href="{{ route('datatransaksi.index') }}" style="background-color: #128FE2; color: white;">Cek Pembayaran</a>
                                            @elseif($or->status == 'Barang Dikemas')
                                                <a class="btn" href="" style="background-color: #128FE2; color: white;">Cetak Pesanan</a>
                                                <a class="btn" href="{{route('dataorder.barangkirim', $or->id)}}" style="background-color: #128FE2; color: white;">Barang Dikirim</a>
                                            @endif
                                        </div>
                        </div>
